...
const projects = [
  {
    ...
    github:
      "https://github.com/himanshuantal5640/AI-Subjective-Exam_Evaluation-Frontend.git",
    live: "#",
    featured: true,
  },
        ...
        >
          {[
            ...
            <div
              ...
              onMouseEnter={(ev) => {
                ev.currentTarget.style.boxShadow = `0 8px 28px ${e.color}22`;
            ...
            >
              ...
              <div style={{ textAlign: "right", flexShrink: 0 }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 800, color: e.color }}>
                  {e.detail}
                </div>
              </div>
            </div>
              ...
              {certifications.map((cert, i) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 4px 16px ${cert.color}18`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = c.border;
                    e.currentTarget.style.boxShadow = "none";
          ...
          {achievements.map((a, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `0 12px 32px ${a.color}22`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = "none";
